...
from detectron2.data import (DatasetCatalog, DatasetFromList, DatasetMapper,
                             MapDataset, build_batch_data_loader,
                             load_proposals_into_dataset)
from detectron2.data.detection_utils import check_metadata_consistency
from detectron2.data.samplers import (RepeatFactorTrainingSampler, InferenceSampler,
                                      TrainingSampler)
...
def build_x_test_loader(dataset, *, mapper, num_workers=0):
    """
